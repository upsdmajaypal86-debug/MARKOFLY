...
export const NotFound = () => {
  return (
    ...
    >
      ...
      <Link 
        to="/"
        className="px-8 py-4 bg-primary hover:bg-primary-dark text-white font-medium rounded-full transition-all duration-300 shadow-lg shadow-primary/30 hover:shadow-primary/50 hover:-translate-y-1"
      >
        Go Back Home
      </Link>
    </motion.div>
