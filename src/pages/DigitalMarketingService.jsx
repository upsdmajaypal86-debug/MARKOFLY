...
import {
  ...
  digitalMarketingHeroPills,
  digitalMarketingHighlights,
  digitalMarketingMetrics,
  digitalMarketingProcess,
  digitalMarketingTechStack,
} from '../content/digitalMarketingService';

const highlightIcons = [Rocket, BarChart3, TrendingUp];
const capabilityIcons = [PieChart, Search, Mail, MessageSquare, Users, BarChart3];
    ...
    >
        ...
        <div className="container mx-auto grid max-w-7xl gap-14 px-6 lg:grid-cols-[1.05fr_0.95fr] lg:items-center">
          <div>
            <nav aria-label="Breadcrumb" className="mb-8 flex flex-wrap items-center gap-2 text-sm text-slate-500">
              ...
              <span>/</span>
              <span className="font-medium text-slate-700">Digital Marketing & Growth</span>
            </nav>
            ...
            <h1 className="max-w-3xl text-4xl font-extrabold leading-tight text-slate-950 md:text-6xl">
              Data-driven digital marketing built to scale your brands reach and revenue.
            </h1>

            <p className="mt-6 max-w-2xl text-lg leading-8 text-slate-600 md:text-xl">
              We connect content strategy, email marketing, and social media into a single high-performing growth engine 
              that drives brand authority and measurable business impact.
            </p>

            <div className="mt-8 flex flex-wrap gap-3">
              {digitalMarketingHeroPills.map((pill) => (
                <span
                  key={pill}
            ...
            <GlassCard className="relative overflow-hidden rounded-[2.5rem] border-white/70 bg-white/80 p-0 shadow-[0_28px_90px_rgba(59,130,246,0.18)]">
              <div className="bg-slate-950 px-6 py-6 text-slate-100">
                ...
                <div className="rounded-[1.75rem] border border-white/10 bg-white/5 p-5 font-mono text-sm leading-7 text-slate-300">
                  <p>{'marketing = {'}</p>
                  <p className="pl-4 text-sky-300">channels: 'omni-present',</p>
                  <p className="pl-4 text-emerald-300">content: 'high-value',</p>
                  <p className="pl-4 text-violet-300">nurture: 'automated-flows',</p>
                  <p className="pl-4 text-amber-300">growth: 'compounding-results'</p>
                  <p>{'}'}</p>
                </div>
              </div>

              <div className="grid gap-4 p-6 md:grid-cols-3">
                {digitalMarketingMetrics.map((metric) => (
      ...
      <Section className="pt-0">
        <div className="mx-auto mb-14 max-w-3xl text-center">
          ...
          <h2 className="text-3xl font-bold text-slate-950 md:text-5xl">
            Success in digital marketing comes from compounding momentum.
          </h2>
          <p className="mt-5 text-lg leading-8 text-slate-600">
            Our growth approach balances creative storytelling, platform optimization, and technical automation so your 
            marketing efforts work together as a single, powerful system.
          </p>
        </div>
      ...
      <Section className="bg-slate-50">
        <div className="grid gap-12 lg:grid-cols-[0.85fr_1.15fr] lg:items-start">
          <div>
            <p className="mb-4 text-sm font-bold uppercase tracking-[0.25em] text-primary">Growth Engines</p>
            <h2 className="text-3xl font-bold text-slate-950 md:text-5xl">
              Modern digital marketing for brands that need to be everywhere.
            </h2>
            <p className="mt-5 text-lg leading-8 text-slate-600">
              Whether you need to generate immediate leads or build a long-term content authority, we shape the 
              mix of channels and tactics around your unique business objectives.
            </p>
            ...
            <div className="mt-10 rounded-[2rem] border border-slate-200 bg-white p-6 shadow-sm">
              ...
              <div className="space-y-4">
                {digitalMarketingDeliverables.map((item) => (
          ...
          <div className="grid gap-6 md:grid-cols-2">
            {digitalMarketingCapabilities.map((item, index) => {
      ...
      <Section>
        <div className="mx-auto mb-14 max-w-3xl text-center">
          ...
          <h2 className="text-3xl font-bold text-slate-950 md:text-5xl">A clear workflow that builds real reach.</h2>
          <p className="mt-5 text-lg leading-8 text-slate-600">
            We follow a structured growth marketing process that focuses on experimentation, consistent cross-channel 
            execution, and deep data insight.
          </p>
        </div>

        <div className="grid gap-6 md:grid-cols-2 xl:grid-cols-4">
          {digitalMarketingProcess.map((item) => (
      ...
      <Section className="bg-slate-950 text-white">
        <div className="grid gap-10 lg:grid-cols-[0.9fr_1.1fr] lg:items-center">
          <div>
            <p className="mb-4 text-sm font-bold uppercase tracking-[0.25em] text-sky-300">Technology & Automation</p>
            <h2 className="text-3xl font-bold md:text-5xl">
              The modern growth stack built for speed and efficiency.
            </h2>
            <p className="mt-5 text-lg leading-8 text-slate-300">
              We leverage best-in-class tools for email, social, and analytics to ensure your marketing system is 
              automated, reliable, and provides the data you need to make confident decisions.
            </p>

            <div className="mt-8 flex flex-wrap gap-3">
              {digitalMarketingTechStack.map((item) => (
                <span
                  key={item}
            ...
            {[
              {
                ...
                description: 'Build email sequences that automatically guide leads toward conversion without manual effort.',
              },
              {
                title: 'Data-led channel optimization',
                description: 'We identify your highest-performing channels and shift our energy where the growth is greatest.',
              },
              {
                title: 'Strategic content engines',
                description: 'Creating high-impact assets that can be repurposed across social, email, and organic search.',
              },
              {
                title: 'End-to-end attribution',
                description: 'Understand the journey from social scroll to final sale with deep analytics and cross-channel tracking.',
              },
            ].map((item) => (
      ...
      <Section className="bg-slate-50">
        <div className="mx-auto mb-14 max-w-3xl text-center">
          ...
          <h2 className="text-3xl font-bold text-slate-950 md:text-5xl">Questions brands ask about their growth.</h2>
          <p className="mt-5 text-lg leading-8 text-slate-600">
            Find answers to common questions about marketing mix, budget allocation, and expectations for digital growth.
          </p>
        </div>

        <div className="grid gap-6 md:grid-cols-2">
          {digitalMarketingFaqs.map((item) => (
      ...
      <CTASection
        title="Ready to fuel your growth engine?"
        description="Tell us about your brand vision, and we will help perform a quick strategic review of your digital marketing mix."
        buttonText="Get a Growth Strategy"
      />
    </motion.div>
  );
};
